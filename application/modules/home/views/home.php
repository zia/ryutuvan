		...
		<div class="scroll_div table-responsive">
			<table class="table table-bordered SO_bg" id="data-table" _fixedhead="rows:0; cols:5">
				...
				<tr>
					...
					<td class="SO_tdtr2c0"><div class="row" id=r<?=$r?>ca></div></td>
					<td class="SO_tdtr2c1"><div class="row" id=r<?=$r?>cb></div></td>
					<td class="SO_tdtr2c2 healthy_border"><div class="row" id=r<?=$r?>cc></div></td>
